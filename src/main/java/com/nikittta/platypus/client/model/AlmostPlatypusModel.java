...
import com.nikittta.platypus.entities.AlmostPlatypusEntity;
...
@OnlyIn(Dist.CLIENT)
public class AlmostPlatypusModel<T extends AlmostPlatypusEntity> extends TintedAgeableModel<T> {
